        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.552 12.017a3.465 3.465 0 117.465 0 3.465 3.465 0 01-7.465 0zm9.099-5.024a.83.83 0 110-1.66.83.83 0 010 1.66zm-1.132 5.024a2.636 2.636 0 11-5.272 0 2.636 2.636 0 015.272 0z"/>
                </svg>
              </a>
              <a
                href="#"
